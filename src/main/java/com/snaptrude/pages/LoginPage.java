...
public class LoginPage extends BasePage {
    ...
    public void fillSignUpForm(String firstName, String email, String password) {
    ...
    public void completeSignUp(String firstName, String email, String password) {
        clickSignUp();
        fillSignUpForm(firstName, email, password);
        clickSignUpButton();
